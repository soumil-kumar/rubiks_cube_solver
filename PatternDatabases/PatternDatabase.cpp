...
PatternDatabase::PatternDatabase(const size_t size, uint8_t init_value) :
        database(size, init_value), size(size), numItems(0) {
}

//Is the index is already set, it does nothing and returns false
//Else if sets ind and return true  
