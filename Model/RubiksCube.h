...
/* 
    A base-class for all Rubiks Cube Models.  There are various representation for Rubik's Cube.
...
class RubiksCube {
    public:
        ...
        */
        ...
        /*
            Randomly shuffle the cube with 'times' moves and returns the move performed
        */
